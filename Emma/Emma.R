...
PridePrejudice <- readtext::readtext ("~/Desktop/MATLIT/Tese/vizualizacoes/RStudio/Emma/Emma.txt*") 
PridePrejudice
...
toks <- PridePrejudice_corpus %>%
  ...
  tokens_tolower() %>%
  tokens_remove(pattern =  c(stopwords("en"), "can", "???", "though", "94", "97", "97and", "97but", "without", "therefore", "yet", "whether", "said", "say", "use", "since", "may", "two",  "still", "upon", 'great', "every", "even", "one?", "must", "?", "one", "us","s"), padding = FALSE)
